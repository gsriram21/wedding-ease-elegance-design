...
- navigation:
  ...
  - button "Ease Bot AI"
- img
- text: Consultation booking saved! You will receive a confirmation email shortly.
- button "Chat":
  - img
  - text: Chat
- button "Wishlist":
...
- text: Just now Y
- paragraph: I want to book a consultation
- text: 01:44 PM W
- paragraph: I'd be happy to help you book a consultation! We offer various consultation types to help plan your perfect wedding.
- button "Book Consultation Schedule a free consultation":
  - img
  - text: Book Consultation
  - paragraph: Schedule a free consultation
...
- text: 01:44 PM W
- paragraph: Perfect! Your consultation booking has been saved. You'll receive a confirmation email with all the details shortly. Is there anything else I can help you with?
- text: 01:44 PM
